...
void Hachiko::Scripting::DebugManager::OnEditor()
{
	...
	Editor::Show<ComponentText>("_text_fps", "ComponentText*", _text_fps);
	Editor::Show<ComponentText>("_text_ms", "ComponentText*", _text_ms);
	Editor::Show("_tp_pos1", _tp_pos1);
	Editor::Show("_tp_pos2", _tp_pos2);
	Editor::Show("_tp_pos3", _tp_pos3);
	Editor::Show("_performance_menu", _performance_menu);
}
