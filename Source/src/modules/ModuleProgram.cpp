...
bool Hachiko::ModuleProgram::Init()
{
    ...
    programs[static_cast<int>(Program::PROGRAMS::PARTICLE_DEPTH)] = CreateProgram(SHADERS_FOLDER "vertex_particle.glsl", SHADERS_FOLDER "fragment_particle_deferred.glsl");
