...
void Hachiko::ResourceTexture::DrawGui()
{
    ...
    Widgets::Label("Width", std::to_string(width));
    Widgets::Label("Height", std::to_string(height));
    Widgets::Label("Format", std::to_string(format));
    Widgets::Label("BPP", std::to_string(bpp));
    ...
    {
        if (Widgets::RadioButton(wrap_modes_string[i], wrap == wrap_modes_enum[i]))
        {
    ...
    {
        if (Widgets::RadioButton(filters_string[i], min_filter == filters_enum[i]))
        {
    ...
    {
        if (Widgets::RadioButton(filters_string[i], mag_filter == filters_enum[i]))
        {
